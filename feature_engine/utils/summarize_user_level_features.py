...
'''
def get_average(user_level_data, column_to_summarize, new_column_name):
...
'''
def get_max(user_level_data, column_to_summarize, new_column_name):
	# grouped_conversation_data = get_count_dataframe(chat_level_data, column_to_summarize)
...
@param new_column_name
'''
def get_min(user_level_data, column_to_summarize, new_column_name):
	# grouped_conversation_data = get_count_dataframe(chat_level_data, column_to_summarize)
...
@param new_column_name
'''
def get_stdev(user_level_data, column_to_summarize, new_column_name):
	# grouped_conversation_data = get_count_dataframe(chat_level_data, column_to_summarize)
...
@param new_column_name
'''
def get_sum(user_level_data, column_to_summarize, new_column_name):
	# grouped_conversation_data = get_count_dataframe(chat_level_data, column_to_summarize)
